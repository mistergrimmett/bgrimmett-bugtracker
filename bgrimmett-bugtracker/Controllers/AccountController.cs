...
namespace bgrimmett_bugtracker.Controllers
{
    ...
    public class AccountController : Universal
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, DisplayName = model.DisplayName, TimeZone = model.TimeZone };
                ...
                if (result.Succeeded)
                {
                    ...
                    //Roles.AddUserToRole(model.Email, "Submitter");
