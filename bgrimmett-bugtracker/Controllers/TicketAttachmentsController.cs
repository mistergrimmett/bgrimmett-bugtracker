...
namespace bgrimmett_bugtracker.Controllers
{
    public class TicketAttachmentsController : Universal
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,MediaUrl,DateCreated,Caption,AuthorUserId")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,MediaUrl,DateCreated,Caption,AuthorUserId")] TicketAttachment ticketAttachment)
        {
            if (ModelState.IsValid)
            {
